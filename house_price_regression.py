...
np.random.seed(42)
house_price=house_size*100+np.random.randint(low=2000,high=70000,size=num_house)
...
# placeholders get updated as we descend in down the gradient
...
with tf.Session() as sess:
    ...
    def animate(i):
        ...
        line.set_ydata((fit_size_factor[i] * train_house_size_norm + fit_price_offsets[
            i]) * train_price_std + train_price_mean)  # update the data
        return line,
